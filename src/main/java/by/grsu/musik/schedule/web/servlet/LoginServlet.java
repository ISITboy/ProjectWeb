...
import by.grsu.musik.schedule.web.Security.AuthenticationFilter;
import by.grsu.musik.schedule.web.Security.User;
...
public class LoginServlet extends HttpServlet {
	...
	static {
		...
		USERS.add(new User("blockeduser", "password3", "Alexander", "Alexandrod").setBlocked(true)); // no permissions to view the site
	}
